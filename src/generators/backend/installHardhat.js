...
const installHardhat = async (verbose = true, installDotEnv, installOpenZeppelin) => {
  ...
  if (existsSync(hardhatFolder)) {
    ...
    const list = [
      ...
      {
        title: "Installing @nomiclabs/hardhat-waffle, ethereum-waffle, chai, @nomiclabs/hardhat-ethers and ethers",
        task: () =>
          install(
            {
